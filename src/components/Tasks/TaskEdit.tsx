...
export default function TaskEdit({ tasks }: { tasks: Task[] }) {
  ...
  return (
    <div className="flex md:min-h-[400px] flex-col p-4 gap-4 border rounded-lg shadow-md">
      ...
      <form
        ...
        className="flex flex-col gap-4 rounded-lg shadow-lg"
      >
        <div className="flex flex-col">
          <input type="hidden" id="id" name="id" value={task.id} />
          <label htmlFor="name" className="text-white mb-1 font-semibold">
            Name
          </label>
          <input
            id="name"
